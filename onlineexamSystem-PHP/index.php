...
.bg {
  /* The image used */
  background-image: url("image/bgms.png");
...
<span class="logo" style="font-family:Calibri;font-size:20px;padding-left:5px;" ><stong>GPA</strong></span>
</a>
  <a href="#">
<span class="logo" style="font-family:Calibri;font-size:20px;padding-left:5px;" >Home</span>
</a>
<a href="http://localhost/phpproject/index.php">
<span class="logo"  style="font-family:Calibri;font-size:20px;">Discuss</span>
</a>
<a href="http://localhost/compiler/index.php">
<span class="logo"  style="font-family:Calibri;font-size:20px;">Compiler</span>
</a>
<a href="http://127.0.0.1:5000/dash">
<span class="logo" style="font-family:Calibri;font-size:20px;">Add Notice</span>
</a>
<a href="http://localhost/onlineexamSystem-PHP/index.php">
<span class="logo"  style="font-family:Calibri;font-size:20px;">Exam</span>
</a>
<a href="http://localhost/studentattendancemgsystem/index.php">
<span class="logo" style="font-family:Calibri;font-size:20px;">Attendence</span>
</a>
</div>
...
<p class="text-center"><b>Register For Exam</b></p>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Branch Name" class="form-control input-md" type="text">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/bg.png" width=100 height=100 alt="Shubham" class="img-rounded">
		 </div>
		 <div class="col-md-5">
